    ...
    <el-col :span="6">
      <el-card class="metric-card" shadow="hover">
        ...
        <div class="metric-value">
          {{ newThisMonth ?? '-' }} <el-tag type="success" size="small">+12%</el-tag>
        </div>
      </el-card>
    </el-col>
    <el-col :span="6">
      <el-card class="metric-card" shadow="hover">
        ...
        <div class="metric-value">
          {{ totalDownloads ?? '-' }} <el-tag type="success" size="small">+18%</el-tag>
        </div>
      </el-card>
    </el-col>
    <el-col :span="6">
...
import type { FormatItem } from '@/config/chartOptions'
